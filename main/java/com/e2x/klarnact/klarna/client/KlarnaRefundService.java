...
@Path("/ordermanagement/v1/orders/{orderId}/refunds")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
@RegisterRestClient
@RegisterClientHeaders(KlarnaHeaderConfig.class)
public interface KlarnaRefundService {

    @POST
    @Path("")
    Uni<Response> createRefund(@PathParam("orderId") String orderId, Refund refund);
}
